      ...
      <div className="container">
        <div className="left">
          ...
          <div className="nav-panel" style={{}}>
            ...
            <p className={location.pathname === "/createCard" ? "active" : ""}>
              <Link to="/createCard" style={{ display: 'flex', alignItems: 'center', color: 'white', textDecoration: 'none' }}>
                <FiberNewRounded style={{ marginRight: '5px' }} />
